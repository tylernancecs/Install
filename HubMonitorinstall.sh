...
sudo tar -xvzf home/tyler_nance/prometheus/node_exporter-1.2.0.linux-amd64.tar.gz

sleep 5
# Symbolic links node_exporter to /usr/bin
sudo ln -s home/tyler_nance/prometheus/node_exporter-1.2.0.linux-amd64/node_exporter /usr/bin
...
sudo wget https://github.com/percona/mongodb_exporter/releases/download/v0.20.6/mongodb_exporter-0.20.6.linux-amd64.tar.gz
sudo tar -xvzf home/tyler_nance/prometheus/mongodb_exporter-0.20.6.linux-amd64.tar.gz

sleep 5
# Symbolic links mongodb_exporter to /usr/bin
sudo ln -s home/tyler_nance/prometheus/mongodb_exporter-0.20.6.linux-amd64/mongodb_exporter /usr/bin
